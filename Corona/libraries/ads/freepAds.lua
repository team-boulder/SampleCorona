...
function this.showInterstitial(ads_option)
	if not this.is_shown_interstitial then
		...
		-- 背景
		interstitial.bg = display.newRect( interstitial.group, _W*0.5, _H*0.5, _W, _H)
		interstitial.bg:setFillColor( 0, 0.8 )
		...
		-- 表示挙動
		interstitial.effect_group.anchorX, interstitial.effect_group.anchorY = 0.5, 0.5
